...
class ParameterEvolutionAgent:
    ...
    def uniform(self, agent):
        return ParameterEvolutionAgent((self.stoppingConstant + agent.stoppingConstant) / 2,
    ...
    @staticmethod
    def randomAgent():
        return ParameterEvolutionAgent(uniform(0, 50), uniform(0, 10), uniform(0, 6), uniform(0, 0.2), uniform(0, 100))
